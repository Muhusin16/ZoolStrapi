...
export interface ApiCloudSolutionCloudSolution extends Schema.CollectionType {
...
export interface ApiECommercePortalECommercePortal
  extends Schema.CollectionType {
  collectionName: 'e_commerce_portals';
  info: {
    singularName: 'e-commerce-portal';
    pluralName: 'e-commerce-portals';
    displayName: 'eCommerce-portal';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::e-commerce-portal.e-commerce-portal',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomePageHomePage extends Schema.CollectionType {
  ...
  attributes: {
    header: Attribute.Component<'elements.heading'>;
    Form: Attribute.Component<'elements.form'>;
    Client_Images: Attribute.Media;
    Card: Attribute.Component<'elements.i-card', true>;
    end_title: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMobileHybridDevelopmentMobileHybridDevelopment
  extends Schema.CollectionType {
  collectionName: 'mobile_hybrid_developments';
  info: {
    singularName: 'mobile-hybrid-development';
    pluralName: 'mobile-hybrid-developments';
    displayName: 'Mobile Hybrid Development';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiTestingTesting extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.Text;
    rSubTitle: Attribute.Blocks;
    description: Attribute.JSON;
    subTitle: Attribute.BigInteger;
    lSubTitle: Attribute.Email;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUiEngineeringUiEngineering extends Schema.CollectionType {
  collectionName: 'ui_engineerings';
  info: {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::ui-engineering.ui-engineering',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiWebProdutWebProdut extends Schema.CollectionType {
  collectionName: 'web_produts';
  info: {
    singularName: 'web-produt';
    pluralName: 'web-produts';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::e-commerce-portal.e-commerce-portal': ApiECommercePortalECommercePortal;
      ...
      'api::web-produt.web-produt': ApiWebProdutWebProdut;
    }
  }
}
